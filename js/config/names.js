...
export const NAME_DEFAULTS = Object.freeze({
  ...
  playtest: Object.freeze({
    ...
    cancel: 'cancel',
    noMic: 'voice recording is not supported in this browser.',
    textPlaceholder: 'type feedback…',
    textSubmit: 'submit',
    ...
    newSessionConfirm: 'end session and start a new one?',
    newSessionYes: 'yes',
    newSessionNo: 'no',
    edited: 'edited',
    ...
    narrowNote: 'this panel is built for a desktop-width window.',
  }),
  tips: Object.freeze({
